...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Monitoring Merchandiser @if (request()->get('status') == 4)
                            (Closed PO)
                        @endif
                    </h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Monitoring Merchandiser @if (request()->get('status') == 4)
                                (Closed PO)
                            @endif
                        </li>
                    </ol>
    ...
    <div class="content-body px-4">
        <div class="d-flex justify-content-end mb-2">
            @if (request()->get('status') != 4)
                <a href="/merchandisermonitoring?status=4" class="btn btn-success mr-2">Tampilkan Closed PO</a>
            @else
                <a href="/merchandisermonitoring" class="btn btn-primary mr-2">Tampilkan PO Aktif</a>
            @endif
        </div>
    ...
    <div class="modal fade" id="poupdatemodal" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/merchandisermonitoring/updatepo" method="post" enctype="multipart/form-data"
                    id="submitform">
                    @csrf
                    <input type="hidden" name="type" value="merchandiser">
    ...
    <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="/merchandisermonitoring/uploadfileattachmentmerchendiser" method="post"
