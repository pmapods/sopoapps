...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Monitoring CIT @if (request()->get('status') == 4)
                            (Closed PO)
                        @endif
                    </h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Monitoring CIT @if (request()->get('status') == 4)
                                (Closed PO)
                            @endif
                        </li>
                    </ol>
    ...
    <div class="content-body px-4">
        <div class="d-flex justify-content-end mb-2">
            @if (request()->get('status') != 4)
                <a href="/citmonitoring?status=4" class="btn btn-success mr-2">Tampilkan Closed PO</a>
            @else
                <a href="/citmonitoring" class="btn btn-primary mr-2">Tampilkan PO Aktif</a>
            @endif
        </div>
        <table id="monitoringPO" class="table table-sm table-bordered small dataTable" role="grid">
            <thead>
                <tr>
                    <th>Nomor PO</th>
    ...
    <div class="modal fade" id="poupdatemodal" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/citmonitoring/updatepo" method="post" enctype="multipart/form-data" id="submitform">
                    @csrf
                    <input type="hidden" name="type" value="cit">
    ...
    <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="/citmonitoring/uploadfileattachmentcitmonitoring" method="post"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#monitoringPO tbody').on('click', 'tr', function() {
                ...
                let salespoint_name = $(this).find('td:eq(5)').text().trim();
                let vendor_name = $(this).find('td:eq(4)').text().trim();
                $('#submitform')[0].reset();
