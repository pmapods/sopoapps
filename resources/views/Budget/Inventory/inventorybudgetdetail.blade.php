...
@section('content')
    ...
    <div class="content-body px-4">
        <div class="row">
            ...
            <div class="col-6 text-right">
                <a class="btn btn-info mr-2"
                    href='/inventorybudget/create/template?budget_upload_id={{ $budget->id }}'>Download</a>
            </div>
        </div>
        <div class="row">
            <div class="col">
        ...
        @if ($budget->status == -1 || $budget->status == 1)
            <form action="/inventorybudget/reviseBudget" method="post" id="submitform" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-6 d-flex align-items-center">
                            <div class="form-group mr-2">
                                ...
                                <input type="file" class="form-control-file" name='file' onclick="this.value = null;"
                                    placeholder="Pilih File Template Inventory" required id="file_template"
                                    accept=".xls, .xlsx" />
                            </div>
                            <div>
                                <a class="btn btn-info mr-2"
                                    href='/inventorybudget/create/template?budget_upload_id={{ $budget->id }}'>Download
                                    Template</a>
                            </div>
                        </div>
                    </div>
