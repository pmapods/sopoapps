...
@section('content')
    ...
    <div class="content-body px-4">
        <div class="row">
            ...
            <div class="col-6 text-right">
                <a class="btn btn-info mr-2"
                    href='/assumptionbudget/create/template?budget_upload_id={{ $budget->id }}'>Download</a>
            </div>
        </div>
        <div class="row">
            <div class="col">
        ...
        @if ($budget->status == -1 || $budget->status == 1)
            <form action="/assumptionbudget/reviseBudget" method="post" id="submitform" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-6 d-flex align-items-center">
                            <div class="form-group mr-2">
                                ...
                                <input type="file" class="form-control-file" name='file' onclick="this.value = null;"
                                    placeholder="Pilih File Template Assumption" required id="file_template"
                                    accept=".xls, .xlsx" />
                            </div>
                            <div class="col-6">
                                <a class="btn btn-info mr-2"
                                    href='/assumptionbudget/create/template?budget_upload_id={{ $budget->id }}'>Download
                                    Template</a>
                            </div>
                        </div>
                    </div>
        ...
        $(document).ready(function() {
            ...
            $('#file_template').change(function(evt) {
                ...
                if (files.length > 0) {
                    ...
                    $.ajax({
                        url: '/assumptionbudget/create/readtemplate',
                        type: 'POST',
                        data: fd,
                        contentType: false,
                        processData: false,
