...
@section('content')
    ...
    <div class="content-body px-4">
        <form action="/createBudgetRequest/assumption" method="post" id="submitform" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-2">
                ...
                <div class="col-4 d-flex align-items-center">
                    <div class="form-group mr-2">
                        ...
                        <input type="file" class="form-control-file" name="file" onclick="this.value=null;"
                            placeholder="Pilih File Template Assumption" id="file_template" required accept=".xls, .xlsx" />
                    </div>
                    <div>
                        <a class="btn btn-info mr-2" href='/assumptionbudget/create/template'>Download Template</a>
                    </div>
                </div>
