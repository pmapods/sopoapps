...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Monitoring Assumption Budget</h1>
            </div>
            <div class="col-sm-6">
...
<div class="d-flex justify-content-end px-4">
    <a href="/assumptionbudget/monitoring/export" class="btn btn-primary">Export Data</a>
</div>
                    ...
                    <tbody>
                        ...
                        @foreach($activeBudget as $budget)
                            <tr>
                                ...
                                <td>{{ $budget->salespoint->region_name() }}</td>
                                <td>{{ $budget->code }}</td>
