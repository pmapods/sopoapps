...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Maintenance Budget</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Masterdata</li>
                    <li class="breadcrumb-item active">Maintenance Budget</li>
                </ol>
            </div>
        </div>
...
<div class="modal fade" id="addBudgetModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="/maintenancebudget/add" method="post" enctype="multipart/form-data">
            @csrf
...
<div class="modal fade" id="detailBudgetModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="/maintenancebudget/update" method="post" enctype="multipart/form">
            @csrf
        ...
        <form action="/maintenancebudget/delete" method="post" id="deleteform">
            @csrf
            <input type="hidden" name="id">
        </form>
    </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#budgetDT tbody').on('click', 'tr', function () {
            ...
            name.val(data['name']);
            uom.val(data['uom']);
            category.val(data['maintenance_budget_category_id']);
