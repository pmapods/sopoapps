...
<div class="content-header py-1">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Purchasing Team Email</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Masterdata</li>
                    <li class="breadcrumb-item">Additional Email</li>
                    <li class="breadcrumb-item active">Purchasing Team Email</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-end mb-3">
        <div width="20%">
            <select class="form-control" id="emailtype_selection">
                ...
                <option value="/additionalemail/purchasing" selected>Purchasing Team Email</option>
                <option value="/additionalemail/ga">GA Team Email</option>
            </select>
        </div>
    </div>
